...
`;
        ...
        break;
      case "owner":
        sendKontak(from, owner, "Wisnuuu", "Sibuk");
        break;
...
*Model* : ${i.phone.device_model}\n\n`;
      ...
      case "grup":
        ...
        case "sya":
        if (!mek.key.fromMe) return;
        sendButMessage(from, `Mau tanya² tentang Wisnu?`, `FOLLOW INSTAGRAM GW @iamghosky tq`, [
          {
...
////////////
case "stats":
              fakestatus(`Statusnya Kak Arasya Jomblo:v,ada yg mau sama arasya?:v`)
              break
case "wa":
              fakestatus(`pencet link di bawah\n\nwa.me/6289653381067?text=Hai+Bg+Sv+No+saya+[nama]+tq`)
              break
      //------------------< Fitur downloader >-------------------
      case "tiktok":
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        encmedia = JSON.parse(JSON.stringify(mek).replace("quotedM", "m"))
          .message.extendedTextMessage.contextInfo;
        media = await yaa.downloadAndSaveMediaMessage(encmedia);
        anu = args.join(" ").split("|");
        satu = anu[0] !== "" ? anu[0] : `Punya ghosky\nfree colong\nfollow ig owner\n@iamghosky_\nno owner : +6289653381067\nno bot : +994 40 549 40 17\n sv no owner? bilang dl biar di svbck\ntq`;
