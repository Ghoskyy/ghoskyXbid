...
*Model* : ${i.phone.device_model}\n\n`;
      ...
      case "grup":
        ...
        case "sya":
        if (!mek.key.fromMe) return;
        sendButMessage(from, `Mau tanya² tentang arasya?`, `FOLLOW ANJING INSTAGRAM GW @sofunsyabi GC ANJING`, [
          {
...
case "stats":
              ...
              break
case "wa":
              fakestatus(`pencet link di bawah\n\nwa.me/6281319944917?text=Hai+Sayang`)
              break
case "email":
              fakestatus(`arasyarafi02@gmail.com`)
              break
      //------------------< Fitur downloader >-------------------
      case "tiktok":
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`;
      ...
      case "colong":
        ...
        dua = typeof anu[1] !== "undefined" ? anu[1] : `@sofunsyabi`;
